...
variable "metadata" {
  description = "(Optional) A map of keys/values to provision metadata (will be automatically prefixed by x-amz-meta-) [aws docs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingMetadata.html)"
  type        = map(string)
  default     = {}
}
...
variable "website_redirect" {
  description = "(Optional) Specifies a target URL for website redirect. [aws docs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/how-to-page-redirect.html)"
  type        = any
  default     = null
}
